...
재미있고 긍정적인 상상력을 발휘하세요. 전 세계 다양한 시대와 문화에서 온 인물들로 매칭을 시도해 주세요. 유럽, 아시아, 아프리카, 아메리카 등 각 대륙의 다양한 인물들을 포함하세요. 또한, 인물들은 고대부터 현대까지 여러 시대를 아우르도록 하세요. 결과에는 역사적 인물의 사진 URL을 포함하세요. 가능한 한 공식적이고 신뢰할 수 있는 출처에서 사진을 선택하세요. 이미지를 가져올 때, Wikimedia 외의 신뢰할 수 있는 이미지 소스를 사용해주세요. Unsplash, Flickr, Google 이미지 검색 등에서 가져올 수 있습니다.
