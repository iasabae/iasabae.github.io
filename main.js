document.addEventListener('DOMContentLoaded', async () => {
  ...
  async function processImage(file) {
    ...
    try {
      ...
      const prompt = `당신은 재미있고 창의적인 '가상 전생 찾기' 게임의 진행자입니다. 업로드된 현대인의 사진을 보고, 그 사람과 닮았거나 비슷한 특징을 가진 역사적 인물을 자유롭게 상상해서 매칭해주세요. 과학적 증거나 정확성은 중요하지 않습니다. 재미있고 긍정적인 상상력을 발휘해주세요. 다음 형식으로 답변해주세요:
